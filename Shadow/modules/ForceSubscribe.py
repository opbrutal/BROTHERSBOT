...
def config(client, message):
    ...
    if user.status is "creator" or user.user.id in OPERATORS:
        chat_id = message.chat.id
...
__help__ = """
<b>ForceSubscribe</b>
- Shadow can mute members who are not subscribed your channel until they subscribe
